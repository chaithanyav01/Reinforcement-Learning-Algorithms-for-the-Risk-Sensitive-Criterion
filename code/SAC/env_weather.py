...
weather_intensity = 0 # Example weather intensity parameter

'''for risk_aversion_lambda=0 i have trained the model by making reward/10.0 in the step function in line 168 and for 
risk_aversion_lambdas rather than 0 i have trained the model by making just reward in the step function in line 168'''
...
class CarlaEnv(gym.Env):
    def __init__(self, risk_aversion_lambda=risk_aversion_lambda,weather_intensity = weather_intensity):
    ...
    def _set_weather(self):
        """Set rainy weather conditions"""
        weather = carla.WeatherParameters(
            precipitation=self.weather_intensity,  # 0-100 (rain intensity)
            precipitation_deposits=0.0,  # Wet surfaces
            cloudiness=10.0,
            wetness=0.0,
